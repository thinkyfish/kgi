...
static void show_msg(kgi_u16_t *fb, kgi_u_t sizex, kgi_u_t sizey)
{
...
static void hide_msg(kgi_u16_t *fb, kgi_u_t sizex, kgi_u_t sizey)
{
	int i;
...
void kgy_splash(video_adapter_t *adp)
{
