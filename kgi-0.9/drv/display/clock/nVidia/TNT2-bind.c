/* ----------------------------------------------------------------------------
**	nVidia TNT2 PLL meta language binding
** ----------------------------------------------------------------------------
...
#include "clock/nVidia/TNT2-bind.h"

kgi_error_t tnt2_clock_init_module(tnt2_clock_t *pgc, tnt2_clock_io_t *tnt2_io,
	const kgim_options_t *options)
{
	KRN_DEBUG(2, "tnt2_clock_init_module()");
	
	kgim_strcpy(pgc->pll.clock.vendor, "nVidia");
	kgim_strcpy(pgc->pll.clock.model, "TNT2 integrated clock");

	pgc->pll.clock.revision	= KGIM_CLOCK_REVISION;
/*	pgc->pll.clock.flags	*/
	pgc->pll.clock.mode_size	= sizeof(tnt2_clock_mode_t);
...
const kgim_meta_t tnt2_clock_meta =
{
	(kgim_meta_init_module_fn *)	tnt2_clock_init_module,
	(kgim_meta_done_module_fn *)	NULL,
	(kgim_meta_init_fn *)		tnt2_clock_init,
	(kgim_meta_done_fn *)		tnt2_clock_done,
	(kgim_meta_mode_check_fn *)	pll_clock_mode_check,
	(kgim_meta_mode_resource_fn *)	NULL,
	(kgim_meta_mode_prepare_fn *)	NULL,
	(kgim_meta_mode_enter_fn *)	tnt2_clock_mode_enter,
	(kgim_meta_mode_leave_fn *)	NULL,
	(kgim_meta_image_resource_fn *)	NULL,

	sizeof(tnt2_clock_t),
	0,
	sizeof(tnt2_clock_mode_t)
};
