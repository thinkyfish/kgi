	...
	const kgim_options_t *options)
{
	...
	kgim_strcpy(mgag->pll.clock.model,  "1x64sg/Gx00 Integated Clock");
...
#warning you should not pass function calls as macro arguments.
/*	reason: macro arguments might get evaluated more than once.
*/
	switch (PCICFG_SIGNATURE(
		pcicfg_in16(MGAG_PCIDEV(mgag_io) + PCI_VENDOR_ID),
		pcicfg_in16(MGAG_PCIDEV(mgag_io) + PCI_DEVICE_ID))) {
