...
#	define DWGCTL_TRANS_SHIFT		16
#	define DWGCTL_TRANS_MASK		(0x0F << DWGCTL_TRANS_SHIFT)
#	define DWGCTL_BLTMOD_SHIFT		16
#	define DWGCTL_BLTMOD_MASK		(0x0F << DWGCTL_BLTMOD_SHIFT)
#	define DWGCTL_BLTMOD_BMONOLEF		(0x00 << DWGCTL_BLTMOD_SHIFT)
#	define DWGCTL_BLTMOD_BMONOWF		(0x04 << DWGCTL_BLTMOD_SHIFT)
#	define DWGCTL_BLTMOD_PLAN		(0x01 << DWGCTL_BLTMOD_SHIFT)
#	define DWGCTL_BLTMOD_BFCOL		(0x02 << DWGCTL_BLTMOD_SHIFT)
#	define DWGCTL_BLTMOD_UYUV		(0x14 << DWGCTL_BLTMOD_SHIFT)
#	define DWGCTL_BLTMOD_32BGR		(0x03 << DWGCTL_BLTMOD_SHIFT)
#	define DWGCTL_BLTMOD_32RGB		(0x07 << DWGCTL_BLTMOD_SHIFT)
#	define DWGCTL_BLTMOD_24BGR		(0x11 << DWGCTL_BLTMOD_SHIFT)
#	define DWGCTL_BLTMOD_24RGB		(0x15 << DWGCTL_BLTMOD_SHIFT)
...
#	define MACCESS_PWIDTH_PW24		(0x02 << MACCESS_PWIDTH_SHIFT)
#	define MACCESS_PWIDTH_PW32		(0x03 << MACCESS_PWIDTH_SHIFT)
...
#	define CXBNDRY_CXLEFT_MASK		(0xFFFF << CXBNDRY_CXLEFT_SHIFT)
#	define CXBNDRY_CXRIGHT_SHIFT		16
#	define CXBNDRY_CXRIGHT_MASK		(0xFFFF << CXBNDRY_CXRIGHT_SHIFT)
