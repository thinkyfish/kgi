...
**
** $Date$ $Revision$
** $Header: //depot/main/glx/server/glxutil.c#15 $
*/
...
{
    __GLXdrawablePrivate *glxPriv = (__GLXdrawablePrivate *)glPriv->wsPriv;
...
LockDP(__GLdrawablePrivate *glPriv, __GLcontext *gc)
{
    ...
    __GLXcontext *glxc = (__GLXcontext *) glci->imports.wscx;
			   ...
			   __GLcontextModes *modes)
{
    ...
    *glPriv->modes = *modes;
    ...
    glPriv->wsPriv = glxPriv;
    glPriv->other = NULL;

#if defined(DEBUG)
    glPriv->lockRefCount = 0;
#endif /* DEBUG */
